...
- 自定义模式：可为每个 AI 座位选择新手、进阶或高手 AI；也可点击“以随机 AI 开始新对局”，按当前人数秘密分配风格并直接开局。随机结果不进入侧边栏选择框，牌桌昵称旁也不显示风格，整场连续对战保持保密。
...
- 行动停留、阶段切换和公共牌翻转采用非阻塞计时；页面不会因等待动画而整体变灰，发牌时只展示牌背翻到正面的过程。
...
- “示例对局”提供固定四人教学牌局：真人固定持有 A♠、K♠，教程 AI 只会跟注或过牌，固定公共牌会让真人组成皇家同花顺。
